...
use crate::enemy::movement_enemy::move_enemy_towards_player_system;
...
use bevy::prelude::*;
use crate::enemy::movement_enemy::move_ranged_enemy_system;
    ...
    fn build(&self, app: &mut App) {
        ...
        .add_systems(
            ...
            (
                ...
                move_ranged_enemy_system.pipe(log_rtg_exception),
                enemy_death_system,
